...
warehouse.add_drawer(Drawer([Material(147, "lmn", 75, 637, 0, warehouse.get_height())]))
warehouse.print_warehouse()
print()

print("Add new drawer (25 * 2): ")
warehouse.add_drawer(Drawer([Material(258, "opq", 50, 103, 0, warehouse.get_height())]))
warehouse.print_warehouse()
print()

# print("Add new drawer (25 * 5, error!): ")
# warehouse.add_drawer(Drawer([Material(369, "rst", 125, 107, 0, warehouse.get_height())]))
# warehouse.print_warehouse()
# print()
