...
class TestSendBackDrawer(TestCase):
    def test_simulate_action_bay_occupied(self):
        ...
        action = SendBackDrawer(simulation.env, simulation.warehouse, simulation)
        ...
        self.assertEqual(ActionEnum.SEND_BACK_DRAWER.value, action_performed['Type of Action'])
